...
from egg_exp.data_augmentation.noise_injection import Musan

class DataPreprocessor:
	def __init__(self, path_musan, path_vox1_test):
		self.path_musan = path_musan
		self.path_vox1_test = os.path.join(path_vox1_test, 'test')
	...
	def check_environment(self):
		...
		if not os.path.exists(self.path_vox1_test_noise):		
			self.musan = Musan(self.path_musan_split + '/test')
